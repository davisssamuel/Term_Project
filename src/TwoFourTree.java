...
public class TwoFourTree implements Dictionary {
    ...
    private void leftFusion(TFNode curr) {
        
        TFNode parent = curr.getParent();
        TFNode leftSib = parent.getChild(whatChildIsThis(curr) - 1);
        
        
    }
    
    private void rightFusion(TFNode curr) {
